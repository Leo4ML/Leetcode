...
#         judge = [arr1[0]+arr1[1], arr1[0]+arr2[0], arr2[0]+arr2[1]]
#     if len(arr1) > 1 and len(arr2) == 1:
#         judge = [arr1[0]+arr1[1], arr1[0]+arr2[0]]
#     if len(arr1) == 1 and len(arr2) > 1:
#         judge = [2**31, arr1[0]+arr2[0], arr2[0]+arr2[1]]
#     if len(arr1) == 1 and len(arr2) == 1:
#         return arr1.pop(0)+arr2.pop(0)
#     index = judge.index(min(judge))
#     if index == 0:
#         tmp = arr1.pop(0)+arr1.pop(1)
#     if index == 1:
#         tmp = arr1.pop(0)+arr2.pop(0)
#     if index == 2:
#         tmp = arr2.pop(0)+arr2.pop(1)
#     return tmp
...
#         arr1.sort()
#         arr2 = []
#         while len(arr1) + len(arr2) > 1:
#             if not arr2:
#                 tmp = arr1.pop(0)+arr1.pop(0)
#                 arr2.append(tmp)
#             elif not arr1:
#                 arr1, arr2 = arr2, arr1
#             else:
